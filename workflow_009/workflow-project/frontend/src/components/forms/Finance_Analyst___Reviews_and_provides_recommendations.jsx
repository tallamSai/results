...
export default function FinanceAnalystReviewsandprovidesrecommendations({ workflowInstanceId = null, previousStageData = null, onSubmit, loading, initialData = {}, disabled = false }) {
  const [formData, setFormData] = useState(initialData);
  
  // Update formData when initialData changes (important for read-only display)
  useEffect(() => {
    if (initialData && Object.keys(initialData).length > 0) {
      console.log(`📝 Form (FinanceAnalystReviewsandprovidesrecommendations): Loading initialData:`, initialData);
...
const handleSubmit = (e) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      />
      <EmployeeHeader 
        title="Finance Analyst - Reviews and provides recommendations"
      ...
      <div className="max-w-6xl mx-auto px-6 py-3">
        <div className="flex items-center text-sm text-gray-600">
          ...
          <span className="text-gray-900 font-medium">Finance Analyst - Reviews and provides recommendations</span>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-gray-700">
                    Recommendation Decision <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <select
                      value={formData['question_d8239e3d'] || ''}
                      onChange={e => handleInputChange('question_d8239e3d', e.target.value)}
                    ...
                    >
                      ...
                      <option value="Approve">Approve</option><option value="Reject">Reject</option><option value="Conditional Approval">Conditional Approval</option>
                    </select>
                ...
                <div className="flex flex-col gap-2 mb-6">
                  <label className="text-sm font-medium text-gray-700">
                    Review Comments and Recommendations <span className="text-red-500">*</span>
                  </label>
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_a2db8f13'] || ''}
                      onChange={e => handleInputChange('question_a2db8f13', e.target.value)}
                      placeholder="Provide detailed comments, rationale, and recommendations for the budget request."
                      rows="4"
              ...
              <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    console.log('Form rejected:', { formData, participant: 'Finance Analyst', action: 'reject' });
                ...
                <button
                  ...
                  onClick={(e) => {
                    console.log('Form approved:', { formData, participant: 'Finance Analyst', action: 'approve' });
                  }}
                >
                  Approve
                </button>
