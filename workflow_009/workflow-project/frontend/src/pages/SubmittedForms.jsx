...
import Department_Manager___Submits_annual_budget_request from '../components/forms/Department_Manager___Submits_annual_budget_request';
import Finance_Analyst___Allocates_budget_in_the_system from '../components/forms/Finance_Analyst___Allocates_budget_in_the_system';
import Finance_Analyst___Reviews_and_provides_recommendations from '../components/forms/Finance_Analyst___Reviews_and_provides_recommendations';

const FORM_TYPE_MAP = {
  'Department Manager Submits Annual Budget Request': Department_Manager___Submits_annual_budget_request,
  'Department_Manager___Submits_annual_budget_request': Department_Manager___Submits_annual_budget_request,
  'Finance Analyst Allocates Budget In The System': Finance_Analyst___Allocates_budget_in_the_system,
  'Finance_Analyst___Allocates_budget_in_the_system': Finance_Analyst___Allocates_budget_in_the_system,
  'Finance Analyst   Reviews And Provides Recommendations': Finance_Analyst___Reviews_and_provides_recommendations,
  'Finance_Analyst___Reviews_and_provides_recommendations': Finance_Analyst___Reviews_and_provides_recommendations,
};
