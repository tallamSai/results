...
export default function Home() {
  ...
  const allForms = [
    { route: 'department-manager-submits-annual-budget-request', name: 'Department Manager Submits Annual Budget Request', description: 'Form for department managers to submit annual budget requests to the finance department...', role: 'Department_Manager' }
  ];
