...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""department-manager-workflow"": {
      ""name"": ""Department_Manager Workflow"",
      ""roleSequence"": [
        ""Department_Manager"",
        ""Finance_Analyst"",
        ""Finance_Director""
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Submits_annual_budget_request_1"",
        ...
        {
          ""taskId"": ""Task_Reviews_and_provides_recommendations_2"",
        ...
        {
          ""taskId"": ""Task_Allocates_budget_in_the_system_5"",
          ""currentRole"": ""Finance_Analyst"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
