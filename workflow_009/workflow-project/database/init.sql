...
-- Schema for Department_Manager_Submits_Annual_Budget_Request
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Department_Manager_Submits_Annual_Budget_Request')
BEGIN
    CREATE TABLE Department_Manager_Submits_Annual_Budget_Request (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Department_Manager_Submits_Annual_Budget_Request
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Manager_Submits_Annual_Budget_Request_WorkflowInstanceId')
CREATE INDEX IX_Department_Manager_Submits_Annual_Budget_Request_WorkflowInstanceId ON Department_Manager_Submits_Annual_Budget_Request(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Manager_Submits_Annual_Budget_Request_UserId')
CREATE INDEX IX_Department_Manager_Submits_Annual_Budget_Request_UserId ON Department_Manager_Submits_Annual_Budget_Request(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Manager_Submits_Annual_Budget_Request_Status')
CREATE INDEX IX_Department_Manager_Submits_Annual_Budget_Request_Status ON Department_Manager_Submits_Annual_Budget_Request(Status);
GO

PRINT 'Department_Manager_Submits_Annual_Budget_Request table created successfully.';
GO


-- Schema for Finance_Analyst_Allocates_Budget_In_The_System
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Analyst_Allocates_Budget_In_The_System')
BEGIN
    CREATE TABLE Finance_Analyst_Allocates_Budget_In_The_System (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Analyst_Allocates_Budget_In_The_System
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Analyst_Allocates_Budget_In_The_System_WorkflowInstanceId')
CREATE INDEX IX_Finance_Analyst_Allocates_Budget_In_The_System_WorkflowInstanceId ON Finance_Analyst_Allocates_Budget_In_The_System(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Analyst_Allocates_Budget_In_The_System_UserId')
CREATE INDEX IX_Finance_Analyst_Allocates_Budget_In_The_System_UserId ON Finance_Analyst_Allocates_Budget_In_The_System(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Analyst_Allocates_Budget_In_The_System_Status')
CREATE INDEX IX_Finance_Analyst_Allocates_Budget_In_The_System_Status ON Finance_Analyst_Allocates_Budget_In_The_System(Status);
GO

PRINT 'Finance_Analyst_Allocates_Budget_In_The_System table created successfully.';
GO


-- Schema for Finance_Analyst___Reviews_And_Provides_Recommendations
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Analyst___Reviews_And_Provides_Recommendations')
BEGIN
    CREATE TABLE Finance_Analyst___Reviews_And_Provides_Recommendations (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Analyst___Reviews_And_Provides_Recommendations
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Analyst___Reviews_And_Provides_Recommendations_WorkflowInstanceId')
CREATE INDEX IX_Finance_Analyst___Reviews_And_Provides_Recommendations_WorkflowInstanceId ON Finance_Analyst___Reviews_And_Provides_Recommendations(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Analyst___Reviews_And_Provides_Recommendations_UserId')
CREATE INDEX IX_Finance_Analyst___Reviews_And_Provides_Recommendations_UserId ON Finance_Analyst___Reviews_And_Provides_Recommendations(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Analyst___Reviews_And_Provides_Recommendations_Status')
CREATE INDEX IX_Finance_Analyst___Reviews_And_Provides_Recommendations_Status ON Finance_Analyst___Reviews_And_Provides_Recommendations(Status);
GO

PRINT 'Finance_Analyst___Reviews_And_Provides_Recommendations table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('department-manager-submits-annual-budget-request', 'Department_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('department-manager-submits-annual-budget-request', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-analyst---reviews-and-provides-recommendations', 'Finance_Analyst', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-analyst---reviews-and-provides-recommendations', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-analyst-allocates-budget-in-the-system', 'Finance_Analyst', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-analyst-allocates-budget-in-the-system', 'Admin', 'Admin');
GO
