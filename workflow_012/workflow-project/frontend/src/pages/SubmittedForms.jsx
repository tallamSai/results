...
import End_User___Reports_an_issue_by_submitting_a_ticket from '../components/forms/End_User___Reports_an_issue_by_submitting_a_ticket';
import IT_Manager___Provides_guidance_or_additional_resources from '../components/forms/IT_Manager___Provides_guidance_or_additional_resources';
import IT_Technician___Investigates_root_cause_and_performs_diagnostics____ from '../components/forms/IT_Technician___Investigates_root_cause_and_performs_diagnostics,...';
import Service_Desk_Agent___Performs_initial_triage__Assigns_incident_to_IT_te___ from '../components/forms/Service_Desk_Agent___Performs_initial_triage,_Assigns_incident_to_IT_te...';

const FORM_TYPE_MAP = {
  'End User   Reports An Issue By Submitting A Ticket': End_User___Reports_an_issue_by_submitting_a_ticket,
  'End_User___Reports_an_issue_by_submitting_a_ticket': End_User___Reports_an_issue_by_submitting_a_ticket,
  'IT Manager   Provides Guidance Or Additional Resources': IT_Manager___Provides_guidance_or_additional_resources,
  'IT_Manager___Provides_guidance_or_additional_resources': IT_Manager___Provides_guidance_or_additional_resources,
  'IT Technician Investigates Root Cause And Performs Diagnostics': IT_Technician___Investigates_root_cause_and_performs_diagnostics____,
  'IT_Technician___Investigates_root_cause_and_performs_diagnostics,...': IT_Technician___Investigates_root_cause_and_performs_diagnostics____,
  'Service Desk Agent   Performs Initial Triage, Assigns Incident To It Te...': Service_Desk_Agent___Performs_initial_triage__Assigns_incident_to_IT_te___,
  'Service_Desk_Agent___Performs_initial_triage,_Assigns_incident_to_IT_te...': Service_Desk_Agent___Performs_initial_triage__Assigns_incident_to_IT_te___,
};
