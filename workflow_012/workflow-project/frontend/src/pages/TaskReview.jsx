...
const ROLE_FORM_MAP = {
  'End_User': End_User___Reports_an_issue_by_submitting_a_ticket,
  'End_User_Step1': End_User___Reports_an_issue_by_submitting_a_ticket,
  'End_User_BpmnStep2': End_User___Reports_an_issue_by_submitting_a_ticket,
  'Service_Desk_Agent': Service_Desk_Agent___Performs_initial_triage__Assigns_incident_to_IT_te___,
  'Service_Desk_Agent_Step1': Service_Desk_Agent___Performs_initial_triage__Assigns_incident_to_IT_te___,
  'Service_Desk_Agent_BpmnStep3': Service_Desk_Agent___Performs_initial_triage__Assigns_incident_to_IT_te___,
  'IT_Technician': IT_Technician___Investigates_root_cause_and_performs_diagnostics____,
  'IT_Technician_Step1': IT_Technician___Investigates_root_cause_and_performs_diagnostics____,
  'IT_Technician_BpmnStep5': IT_Technician___Investigates_root_cause_and_performs_diagnostics____,
  'IT_Manager': IT_Manager___Provides_guidance_or_additional_resources,
  'IT_Manager_Step1': IT_Manager___Provides_guidance_or_additional_resources,
  'IT_Manager_BpmnStep8': IT_Manager___Provides_guidance_or_additional_resources,
};
