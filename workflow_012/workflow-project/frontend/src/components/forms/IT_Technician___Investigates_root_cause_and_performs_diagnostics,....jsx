...
export default function ITTechnicianInvestigatesrootcauseandperformsdiagnostics({ workflowInstanceId = null, previousStageData = null, onSubmit, loading, initialData = {}, disabled = false }) {
  const [formData, setFormData] = useState(initialData);
  
  // Update formData when initialData changes (important for read-only display)
  useEffect(() => {
    if (initialData && Object.keys(initialData).length > 0) {
      console.log(`📝 Form (ITTechnicianInvestigatesrootcauseandperformsdiagnostics): Loading initialData:`, initialData);
...
const handleSubmit = (e) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      />
      <EmployeeHeader 
        title="IT Technician - Investigates root cause and performs diagnostics,..."
        subtitle="IT Technician Process"
      ...
      <div className="max-w-6xl mx-auto px-6 py-3">
        <div className="flex items-center text-sm text-gray-600">
          ...
          <span className="text-gray-900 font-medium">IT Technician - Investigates root cause and performs diagnostics,...</span>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex flex-col gap-2 mb-6">
                  <label className="text-sm font-medium text-gray-700">
                    Root Cause Identified <span className="text-red-500">*</span>
                  </label>
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_7368c9e0'] || ''}
                      onChange={e => handleInputChange('question_7368c9e0', e.target.value)}
                ...
                <div className="flex flex-col gap-2 mb-6">
                  <label className="text-sm font-medium text-gray-700">
                    Diagnostics Performed <span className="text-red-500">*</span>
                  </label>
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_6b1ccf1e'] || ''}
                      onChange={e => handleInputChange('question_6b1ccf1e', e.target.value)}
                      placeholder="Outline the diagnostic steps taken to investigate the issue"
                      rows="4"
                      className="w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 outline-none resize-none rounded-md focus:ring-2 focus:ring-blue-500 transition-colors"
                      required
                    />
                ...
                <div className="flex flex-col gap-2 mb-6">
                  <label className="text-sm font-medium text-gray-700">
                    Fix or Workaround Implemented <span className="text-red-500">*</span>
                  </label>
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_6bf8e6bf'] || ''}
                      onChange={e => handleInputChange('question_6bf8e6bf', e.target.value)}
                      placeholder="Document the solution implemented (fix or workaround)"
                      rows="4"
                      className="w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 outline-none resize-none rounded-md focus:ring-2 focus:ring-blue-500 transition-colors"
                      required
                    />
                ...
                <div className="flex flex-col gap-2 mb-6">
                  ...
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_e6bd647d'] || ''}
                      onChange={e => handleInputChange('question_e6bd647d', e.target.value)}
                      placeholder="Summarize the steps taken to resolve the issue"
                      rows="4"
                      className="w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 outline-none resize-none rounded-md focus:ring-2 focus:ring-blue-500 transition-colors"
                      required
                    />
                ...
                <div className="flex flex-col gap-2 mb-6">
                  ...
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_dea4cacf'] || ''}
                      onChange={e => handleInputChange('question_dea4cacf', e.target.value)}
                ...
                <div className="flex flex-col gap-2 mb-6">
                  <label className="text-sm font-medium text-gray-700">
                    Preventive Recommendations <span className="text-red-500">*</span>
                  </label>
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_b3db2e6c'] || ''}
                      onChange={e => handleInputChange('question_b3db2e6c', e.target.value)}
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-gray-700">
                    Escalation Status <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <select
                      value={formData['question_6aea338e'] || ''}
                      onChange={e => handleInputChange('question_6aea338e', e.target.value)}
