...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""end-user-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Reports_an_issue_by_submitting_a_ticket_1"",
        ...
        {
          ""taskId"": ""Task_Performs_initial_triage_2"",
          ""currentRole"": ""Service_Desk_Agent"",
          ""nextRoles"": [
            ""Service_Desk_Agent""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Assigns_incident_to_IT_technician_3"",
          ""currentRole"": ""Service_Desk_Agent"",
          ""nextRoles"": [
            ""IT_Technician""
          ],
        ...
        {
          ""taskId"": ""Task_Investigates_root_cause_and_performs_dia_4"",
          ""currentRole"": ""IT_Technician"",
          ""nextRoles"": [
            ""IT_Technician""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Implements_fix_or_workaround_5"",
          ""currentRole"": ""IT_Technician"",
          ""nextRoles"": [
            ""IT_Manager""
          ],
        ...
        {
          ""taskId"": ""Task_Provides_guidance_or_additional_resource_7"",
