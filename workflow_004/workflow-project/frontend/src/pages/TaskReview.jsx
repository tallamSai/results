...
import Direct_Manager___Confirms_pending_work_handover_status from '../components/forms/Direct_Manager___Confirms_pending_work_handover_status';
import Finance_Officer___Processes_final_settlement_with_pending_salary__le___ from '../components/forms/Finance_Officer___Processes_final_settlement_with_pending_salary,_le...';
import HR_Representative___Initiates_offboarding_by_entering_employee_name__l___ from '../components/forms/HR_Representative___Initiates_offboarding_by_entering_employee_name,_l...';
import IT_Administrator___Revokes_system_access_and_collects_equipment_inclu___ from '../components/forms/IT_Administrator___Revokes_system_access_and_collects_equipment_inclu...';

const ROLE_FORM_MAP = {
  'HR_Representative': HR_Representative___Initiates_offboarding_by_entering_employee_name__l___,
  'HR_Representative_Step1': HR_Representative___Initiates_offboarding_by_entering_employee_name__l___,
  'HR_Representative_BpmnStep2': HR_Representative___Initiates_offboarding_by_entering_employee_name__l___,
  'Direct_Manager': Direct_Manager___Confirms_pending_work_handover_status,
  'Direct_Manager_Step1': Direct_Manager___Confirms_pending_work_handover_status,
  'Direct_Manager_BpmnStep3': Direct_Manager___Confirms_pending_work_handover_status,
  'IT_Administrator': IT_Administrator___Revokes_system_access_and_collects_equipment_inclu___,
  'IT_Administrator_Step1': IT_Administrator___Revokes_system_access_and_collects_equipment_inclu___,
  'IT_Administrator_BpmnStep4': IT_Administrator___Revokes_system_access_and_collects_equipment_inclu___,
  'Finance_Officer': Finance_Officer___Processes_final_settlement_with_pending_salary__le___,
  'Finance_Officer_Step1': Finance_Officer___Processes_final_settlement_with_pending_salary__le___,
  'Finance_Officer_BpmnStep5': Finance_Officer___Processes_final_settlement_with_pending_salary__le___,
};
