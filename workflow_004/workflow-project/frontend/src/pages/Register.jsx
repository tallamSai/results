        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <option value="Direct_Manager">Direct_Manager</option>
              <option value="Finance_Officer">Finance_Officer</option>
              <option value="HR_Representative">HR_Representative</option>
              <option value="IT_Administrator">IT_Administrator</option>
              </select>
            </div>
