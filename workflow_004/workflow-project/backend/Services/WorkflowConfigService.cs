...
namespace WorkflowManagementSystem.Services
{
    public class WorkflowConfigService
    {
        ...
        private void LoadDefaultConfiguration()
        {
            var configJson = @"{
  ""workflows"": {
    ""hr-representative-workflow"": {
      ""name"": ""HR_Representative Workflow"",
      ""roleSequence"": [
        ""HR_Representative"",
        ""Direct_Manager"",
        ""IT_Administrator"",
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Initiates_offboarding_by_entering_employ_1"",
          ""currentRole"": ""HR_Representative"",
          ""nextRoles"": [
            ""Direct_Manager""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Confirms_pending_work_handover_status_2"",
        ...
        {
          ""taskId"": ""Task_Revokes_system_access_and_collects_equip_3"",
          ""currentRole"": ""IT_Administrator"",
          ""nextRoles"": [
            ""Finance_Officer""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Processes_final_settlement_with_pending__4"",
        ...
        {
          ""taskId"": ""Task_Conducts_exit_interview_and_archives_emp_5"",
          ""currentRole"": ""HR_Representative"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
