...
-- Schema for Department_Head_Reviews_The_Evaluation
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Department_Head_Reviews_The_Evaluation')
BEGIN
    CREATE TABLE Department_Head_Reviews_The_Evaluation (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Department_Head_Reviews_The_Evaluation
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Head_Reviews_The_Evaluation_WorkflowInstanceId')
CREATE INDEX IX_Department_Head_Reviews_The_Evaluation_WorkflowInstanceId ON Department_Head_Reviews_The_Evaluation(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Head_Reviews_The_Evaluation_UserId')
CREATE INDEX IX_Department_Head_Reviews_The_Evaluation_UserId ON Department_Head_Reviews_The_Evaluation(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Head_Reviews_The_Evaluation_Status')
CREATE INDEX IX_Department_Head_Reviews_The_Evaluation_Status ON Department_Head_Reviews_The_Evaluation(Status);
GO

PRINT 'Department_Head_Reviews_The_Evaluation table created successfully.';
GO


-- Schema for Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat...')
BEGIN
    CREATE TABLE Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat..._WorkflowInstanceId')
CREATE INDEX IX_Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat..._WorkflowInstanceId ON Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat..._UserId')
CREATE INDEX IX_Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat..._UserId ON Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat..._Status')
CREATE INDEX IX_Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat..._Status ON Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat...(Status);
GO

PRINT 'Direct_Manager___Completes_The_Performance_Evaluation_Form_With_Rat... table created successfully.';
GO


-- Schema for HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ...')
BEGIN
    CREATE TABLE HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ..._WorkflowInstanceId')
CREATE INDEX IX_HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ..._WorkflowInstanceId ON HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ..._UserId')
CREATE INDEX IX_HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ..._UserId ON HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ..._Status')
CREATE INDEX IX_HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ..._Status ON HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ...(Status);
GO

PRINT 'HR_Representative___Initiates_The_Review_Cycle_By_Selecting_The_Employ... table created successfully.';
GO


-- Schema for Hr_Representative_Schedules_A_Feedback_Meeting
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Hr_Representative_Schedules_A_Feedback_Meeting')
BEGIN
    CREATE TABLE Hr_Representative_Schedules_A_Feedback_Meeting (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Hr_Representative_Schedules_A_Feedback_Meeting
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Hr_Representative_Schedules_A_Feedback_Meeting_WorkflowInstanceId')
CREATE INDEX IX_Hr_Representative_Schedules_A_Feedback_Meeting_WorkflowInstanceId ON Hr_Representative_Schedules_A_Feedback_Meeting(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Hr_Representative_Schedules_A_Feedback_Meeting_UserId')
CREATE INDEX IX_Hr_Representative_Schedules_A_Feedback_Meeting_UserId ON Hr_Representative_Schedules_A_Feedback_Meeting(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Hr_Representative_Schedules_A_Feedback_Meeting_Status')
CREATE INDEX IX_Hr_Representative_Schedules_A_Feedback_Meeting_Status ON Hr_Representative_Schedules_A_Feedback_Meeting(Status);
GO

PRINT 'Hr_Representative_Schedules_A_Feedback_Meeting table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative---initiates-the-review-cycle-by-selecting-the-employ...', 'HR_Representative', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative---initiates-the-review-cycle-by-selecting-the-employ...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---completes-the-performance-evaluation-form-with-rat...', 'Direct_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---completes-the-performance-evaluation-form-with-rat...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('department-head-reviews-the-evaluation', 'Department_Head', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('department-head-reviews-the-evaluation', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative-schedules-a-feedback-meeting', 'HR_Representative', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative-schedules-a-feedback-meeting', 'Admin', 'Admin');
GO
