...
import Accounts_Payable_Clerk___Receives_and_logs_invoice_with_vendor_name__invoic___ from '../components/forms/Accounts_Payable_Clerk___Receives_and_logs_invoice_with_vendor_name,_invoic...';
import Department_Manager___Verifies_goods_or_services_received from '../components/forms/Department_Manager___Verifies_goods_or_services_received';
import Finance_Manager___Reviews_for_budget_allocation from '../components/forms/Finance_Manager___Reviews_for_budget_allocation';
import Vendor___Receives_payment_confirmation from '../components/forms/Vendor___Receives_payment_confirmation';

const ROLE_FORM_MAP = {
  'Accounts_Payable_Clerk': Accounts_Payable_Clerk___Receives_and_logs_invoice_with_vendor_name__invoic___,
  'Accounts_Payable_Clerk_Step1': Accounts_Payable_Clerk___Receives_and_logs_invoice_with_vendor_name__invoic___,
  'Accounts_Payable_Clerk_BpmnStep2': Accounts_Payable_Clerk___Receives_and_logs_invoice_with_vendor_name__invoic___,
  'Department_Manager': Department_Manager___Verifies_goods_or_services_received,
  'Department_Manager_Step1': Department_Manager___Verifies_goods_or_services_received,
  'Department_Manager_BpmnStep3': Department_Manager___Verifies_goods_or_services_received,
  'Finance_Manager': Finance_Manager___Reviews_for_budget_allocation,
  'Finance_Manager_Step1': Finance_Manager___Reviews_for_budget_allocation,
  'Finance_Manager_BpmnStep5': Finance_Manager___Reviews_for_budget_allocation,
  'Vendor': Vendor___Receives_payment_confirmation,
  'Vendor_Step1': Vendor___Receives_payment_confirmation,
  'Vendor_BpmnStep8': Vendor___Receives_payment_confirmation,
};
