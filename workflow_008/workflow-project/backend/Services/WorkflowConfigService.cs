...
namespace WorkflowManagementSystem.Services
{
    public class WorkflowConfigService
    {
        ...
        private void LoadDefaultConfiguration()
        {
            var configJson = @"{
  ""workflows"": {
    ""accounts-payable-clerk-workflow"": {
      ""name"": ""Accounts_Payable_Clerk Workflow"",
      ""roleSequence"": [
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Receives_and_logs_invoice_with_vendor_na_1"",
          ""currentRole"": ""Accounts_Payable_Clerk"",
          ""nextRoles"": [
            ""Department_Manager""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Verifies_goods_or_services_received_2"",
        ...
        {
          ""taskId"": ""Task_Reviews_for_budget_allocation_4"",
        ...
        {
          ""taskId"": ""Task_Schedules_payment_and_records_transactio_5"",
          ""currentRole"": ""Accounts_Payable_Clerk"",
          ""nextRoles"": [
            ""Vendor""
          ],
        ...
        {
          ""taskId"": ""Task_Receives_payment_confirmation_6"",
          ""currentRole"": ""Vendor"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
