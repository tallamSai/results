...
-- Schema for Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic...')
BEGIN
    CREATE TABLE Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic... (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic..._WorkflowInstanceId')
CREATE INDEX IX_Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic..._WorkflowInstanceId ON Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic..._UserId')
CREATE INDEX IX_Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic..._UserId ON Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic..._Status')
CREATE INDEX IX_Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic..._Status ON Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic...(Status);
GO

PRINT 'Accounts_Payable_Clerk___Receives_And_Logs_Invoice_With_Vendor_Name,_Invoic... table created successfully.';
GO


-- Schema for Department_Manager_Verifies_Goods_Or_Services_Received
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Department_Manager_Verifies_Goods_Or_Services_Received')
BEGIN
    CREATE TABLE Department_Manager_Verifies_Goods_Or_Services_Received (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Department_Manager_Verifies_Goods_Or_Services_Received
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Manager_Verifies_Goods_Or_Services_Received_WorkflowInstanceId')
CREATE INDEX IX_Department_Manager_Verifies_Goods_Or_Services_Received_WorkflowInstanceId ON Department_Manager_Verifies_Goods_Or_Services_Received(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Manager_Verifies_Goods_Or_Services_Received_UserId')
CREATE INDEX IX_Department_Manager_Verifies_Goods_Or_Services_Received_UserId ON Department_Manager_Verifies_Goods_Or_Services_Received(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Department_Manager_Verifies_Goods_Or_Services_Received_Status')
CREATE INDEX IX_Department_Manager_Verifies_Goods_Or_Services_Received_Status ON Department_Manager_Verifies_Goods_Or_Services_Received(Status);
GO

PRINT 'Department_Manager_Verifies_Goods_Or_Services_Received table created successfully.';
GO


-- Schema for Finance_Manager___Reviews_For_Budget_Allocation
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Manager___Reviews_For_Budget_Allocation')
BEGIN
    CREATE TABLE Finance_Manager___Reviews_For_Budget_Allocation (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Manager___Reviews_For_Budget_Allocation
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Manager___Reviews_For_Budget_Allocation_WorkflowInstanceId')
CREATE INDEX IX_Finance_Manager___Reviews_For_Budget_Allocation_WorkflowInstanceId ON Finance_Manager___Reviews_For_Budget_Allocation(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Manager___Reviews_For_Budget_Allocation_UserId')
CREATE INDEX IX_Finance_Manager___Reviews_For_Budget_Allocation_UserId ON Finance_Manager___Reviews_For_Budget_Allocation(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Manager___Reviews_For_Budget_Allocation_Status')
CREATE INDEX IX_Finance_Manager___Reviews_For_Budget_Allocation_Status ON Finance_Manager___Reviews_For_Budget_Allocation(Status);
GO

PRINT 'Finance_Manager___Reviews_For_Budget_Allocation table created successfully.';
GO


-- Schema for Vendor___Receives_Payment_Confirmation
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Vendor___Receives_Payment_Confirmation')
BEGIN
    CREATE TABLE Vendor___Receives_Payment_Confirmation (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Vendor___Receives_Payment_Confirmation
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Vendor___Receives_Payment_Confirmation_WorkflowInstanceId')
CREATE INDEX IX_Vendor___Receives_Payment_Confirmation_WorkflowInstanceId ON Vendor___Receives_Payment_Confirmation(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Vendor___Receives_Payment_Confirmation_UserId')
CREATE INDEX IX_Vendor___Receives_Payment_Confirmation_UserId ON Vendor___Receives_Payment_Confirmation(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Vendor___Receives_Payment_Confirmation_Status')
CREATE INDEX IX_Vendor___Receives_Payment_Confirmation_Status ON Vendor___Receives_Payment_Confirmation(Status);
GO

PRINT 'Vendor___Receives_Payment_Confirmation table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('accounts-payable-clerk---receives-and-logs-invoice-with-vendor-name,-invoic...', 'Accounts_Payable_Clerk', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('accounts-payable-clerk---receives-and-logs-invoice-with-vendor-name,-invoic...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('department-manager-verifies-goods-or-services-received', 'Department_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('department-manager-verifies-goods-or-services-received', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-manager---reviews-for-budget-allocation', 'Finance_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-manager---reviews-for-budget-allocation', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('vendor---receives-payment-confirmation', 'Vendor', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('vendor---receives-payment-confirmation', 'Admin', 'Admin');
GO
