...
const ROLE_FORM_MAP = {
  'Employee': Employee___Requests_system_access_with_system_name__access_ty___,
  'Employee_Step1': Employee___Requests_system_access_with_system_name__access_ty___,
  'Employee_BpmnStep2': Employee___Requests_system_access_with_system_name__access_ty___,
  'IT_Administrator': IT_Administrator___Provisions_access_and_sends_credentials,
  'IT_Administrator_Step1': IT_Administrator___Provisions_access_and_sends_credentials,
  'IT_Administrator_BpmnStep4': IT_Administrator___Provisions_access_and_sends_credentials,
};
