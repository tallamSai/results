...
-- Schema for Finance_Officer___Sets_Up_Payroll
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Officer___Sets_Up_Payroll')
BEGIN
    CREATE TABLE Finance_Officer___Sets_Up_Payroll (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Finance_Officer___Sets_Up_Payroll
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Sets_Up_Payroll_WorkflowInstanceId')
CREATE INDEX IX_Finance_Officer___Sets_Up_Payroll_WorkflowInstanceId ON Finance_Officer___Sets_Up_Payroll(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Sets_Up_Payroll_UserId')
CREATE INDEX IX_Finance_Officer___Sets_Up_Payroll_UserId ON Finance_Officer___Sets_Up_Payroll(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Sets_Up_Payroll_Status')
CREATE INDEX IX_Finance_Officer___Sets_Up_Payroll_Status ON Finance_Officer___Sets_Up_Payroll(Status);
GO

PRINT 'Finance_Officer___Sets_Up_Payroll table created successfully.';
GO


-- Schema for HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa...')
BEGIN
    CREATE TABLE HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa..._WorkflowInstanceId')
CREATE INDEX IX_HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa..._WorkflowInstanceId ON HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa..._UserId')
CREATE INDEX IX_HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa..._UserId ON HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa..._Status')
CREATE INDEX IX_HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa..._Status ON HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa...(Status);
GO

PRINT 'HR_Representative___Collects_New_Hire_Information,_Sends_Welcome_Packa... table created successfully.';
GO


-- Schema for Hiring_Manager_Reviews_The_Submission
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Hiring_Manager_Reviews_The_Submission')
BEGIN
    CREATE TABLE Hiring_Manager_Reviews_The_Submission (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Hiring_Manager_Reviews_The_Submission
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Hiring_Manager_Reviews_The_Submission_WorkflowInstanceId')
CREATE INDEX IX_Hiring_Manager_Reviews_The_Submission_WorkflowInstanceId ON Hiring_Manager_Reviews_The_Submission(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Hiring_Manager_Reviews_The_Submission_UserId')
CREATE INDEX IX_Hiring_Manager_Reviews_The_Submission_UserId ON Hiring_Manager_Reviews_The_Submission(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Hiring_Manager_Reviews_The_Submission_Status')
CREATE INDEX IX_Hiring_Manager_Reviews_The_Submission_Status ON Hiring_Manager_Reviews_The_Submission(Status);
GO

PRINT 'Hiring_Manager_Reviews_The_Submission table created successfully.';
GO


-- Schema for IT_Administrator___Provisions_System_Access
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'IT_Administrator___Provisions_System_Access')
BEGIN
    CREATE TABLE IT_Administrator___Provisions_System_Access (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for IT_Administrator___Provisions_System_Access
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Administrator___Provisions_System_Access_WorkflowInstanceId')
CREATE INDEX IX_IT_Administrator___Provisions_System_Access_WorkflowInstanceId ON IT_Administrator___Provisions_System_Access(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Administrator___Provisions_System_Access_UserId')
CREATE INDEX IX_IT_Administrator___Provisions_System_Access_UserId ON IT_Administrator___Provisions_System_Access(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Administrator___Provisions_System_Access_Status')
CREATE INDEX IX_IT_Administrator___Provisions_System_Access_Status ON IT_Administrator___Provisions_System_Access(Status);
GO

PRINT 'IT_Administrator___Provisions_System_Access table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative---collects-new-hire-information,-sends-welcome-packa...', 'HR_Representative', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative---collects-new-hire-information,-sends-welcome-packa...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hiring-manager-reviews-the-submission', 'Hiring_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hiring-manager-reviews-the-submission', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-administrator---provisions-system-access', 'IT_Administrator', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-administrator---provisions-system-access', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---sets-up-payroll', 'Finance_Officer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---sets-up-payroll', 'Admin', 'Admin');
GO
