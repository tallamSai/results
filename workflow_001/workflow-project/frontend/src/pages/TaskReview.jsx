...
const ROLE_FORM_MAP = {
  'HR_Representative': HR_Representative___Collects_new_hire_information__Sends_welcome_packa___,
  'HR_Representative_Step1': HR_Representative___Collects_new_hire_information__Sends_welcome_packa___,
  'HR_Representative_BpmnStep2': HR_Representative___Collects_new_hire_information__Sends_welcome_packa___,
  'Hiring_Manager': Hiring_Manager___Reviews_the_submission,
  'Hiring_Manager_Step1': Hiring_Manager___Reviews_the_submission,
  'Hiring_Manager_BpmnStep3': Hiring_Manager___Reviews_the_submission,
  'IT_Administrator': IT_Administrator___Provisions_system_access,
  'IT_Administrator_Step1': IT_Administrator___Provisions_system_access,
  'IT_Administrator_BpmnStep5': IT_Administrator___Provisions_system_access,
  'Finance_Officer': Finance_Officer___Sets_up_payroll,
  'Finance_Officer_Step1': Finance_Officer___Sets_up_payroll,
  'Finance_Officer_BpmnStep7': Finance_Officer___Sets_up_payroll,
};
