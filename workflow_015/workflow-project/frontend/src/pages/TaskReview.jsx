...
const ROLE_FORM_MAP = {
  'Procurement_Officer': Procurement_Officer___Initiates_vendor_registration_with_company_name__c___,
  'Procurement_Officer_Step1': Procurement_Officer___Initiates_vendor_registration_with_company_name__c___,
  'Procurement_Officer_BpmnStep2': Procurement_Officer___Initiates_vendor_registration_with_company_name__c___,
  'Compliance_Officer': Compliance_Officer___Reviews_legal_documents_including_business_license___,
  'Compliance_Officer_Step1': Compliance_Officer___Reviews_legal_documents_including_business_license___,
  'Compliance_Officer_BpmnStep3': Compliance_Officer___Reviews_legal_documents_including_business_license___,
  'Finance_Officer': Finance_Officer___Sets_up_vendor_in_payment_system_with_bank_details___,
  'Finance_Officer_Step1': Finance_Officer___Sets_up_vendor_in_payment_system_with_bank_details___,
  'Finance_Officer_BpmnStep4': Finance_Officer___Sets_up_vendor_in_payment_system_with_bank_details___,
  'Vendor': Vendor___Receives_confirmation_and_welcome_package,
  'Vendor_Step1': Vendor___Receives_confirmation_and_welcome_package,
  'Vendor_BpmnStep6': Vendor___Receives_confirmation_and_welcome_package,
};
