...
import Direct_Manager___Verifies from '../components/forms/Direct_Manager___Verifies';
import Employee___Submits_expense_claim_with_expense_type__amount__d___ from '../components/forms/Employee___Submits_expense_claim_with_expense_type,_amount,_d...';
import Finance_Officer___Processes_payment_by_entering_payment_date_and_tra___ from '../components/forms/Finance_Officer___Processes_payment_by_entering_payment_date_and_tra...';
import Finance_Officer___Reviews_for_policy_compliance from '../components/forms/Finance_Officer___Reviews_for_policy_compliance';

const FORM_TYPE_MAP = {
  'Direct Manager   Verifies': Direct_Manager___Verifies,
  'Direct_Manager___Verifies': Direct_Manager___Verifies,
  'Employee   Submits Expense Claim With Expense Type, Amount, D...': Employee___Submits_expense_claim_with_expense_type__amount__d___,
  'Employee___Submits_expense_claim_with_expense_type,_amount,_d...': Employee___Submits_expense_claim_with_expense_type__amount__d___,
  'Finance Officer   Processes Payment By Entering Payment Date And Tra...': Finance_Officer___Processes_payment_by_entering_payment_date_and_tra___,
  'Finance_Officer___Processes_payment_by_entering_payment_date_and_tra...': Finance_Officer___Processes_payment_by_entering_payment_date_and_tra___,
  'Finance Officer   Reviews For Policy Compliance': Finance_Officer___Reviews_for_policy_compliance,
  'Finance_Officer___Reviews_for_policy_compliance': Finance_Officer___Reviews_for_policy_compliance,
};
