...
export default function DirectManagerVerifies({ workflowInstanceId = null, previousStageData = null, onSubmit, loading, initialData = {}, disabled = false }) {
  const [formData, setFormData] = useState(initialData);
  
  // Update formData when initialData changes (important for read-only display)
  useEffect(() => {
    if (initialData && Object.keys(initialData).length > 0) {
      console.log(`📝 Form (DirectManagerVerifies): Loading initialData:`, initialData);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-3">
        <div className="flex items-center text-sm text-gray-600">
          ...
          <span className="text-gray-900 font-medium">Direct Manager - Verifies</span>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <select
                      value={formData['question_b65860c7'] || ''}
                      onChange={e => handleInputChange('question_b65860c7', e.target.value)}
                ...
                <div className="flex flex-col gap-2 mb-6">
                  ...
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_769ea63a'] || ''}
                      onChange={e => handleInputChange('question_769ea63a', e.target.value)}
                      placeholder="Enter any comments or notes regarding the verification..."
                      rows="4"
