...
-- Schema for Direct_Manager___Verifies
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Direct_Manager___Verifies')
BEGIN
    CREATE TABLE Direct_Manager___Verifies (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Direct_Manager___Verifies
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Verifies_WorkflowInstanceId')
CREATE INDEX IX_Direct_Manager___Verifies_WorkflowInstanceId ON Direct_Manager___Verifies(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Verifies_UserId')
CREATE INDEX IX_Direct_Manager___Verifies_UserId ON Direct_Manager___Verifies(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Verifies_Status')
CREATE INDEX IX_Direct_Manager___Verifies_Status ON Direct_Manager___Verifies(Status);
GO

PRINT 'Direct_Manager___Verifies table created successfully.';
GO


-- Schema for Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D...')
BEGIN
    CREATE TABLE Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D..._WorkflowInstanceId')
CREATE INDEX IX_Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D..._WorkflowInstanceId ON Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D..._UserId')
CREATE INDEX IX_Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D..._UserId ON Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D..._Status')
CREATE INDEX IX_Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D..._Status ON Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D...(Status);
GO

PRINT 'Employee___Submits_Expense_Claim_With_Expense_Type,_Amount,_D... table created successfully.';
GO


-- Schema for Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra...')
BEGIN
    CREATE TABLE Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra..._WorkflowInstanceId')
CREATE INDEX IX_Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra..._WorkflowInstanceId ON Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra..._UserId')
CREATE INDEX IX_Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra..._UserId ON Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra..._Status')
CREATE INDEX IX_Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra..._Status ON Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra...(Status);
GO

PRINT 'Finance_Officer___Processes_Payment_By_Entering_Payment_Date_And_Tra... table created successfully.';
GO


-- Schema for Finance_Officer___Reviews_For_Policy_Compliance
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Officer___Reviews_For_Policy_Compliance')
BEGIN
    CREATE TABLE Finance_Officer___Reviews_For_Policy_Compliance (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Officer___Reviews_For_Policy_Compliance
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Reviews_For_Policy_Compliance_WorkflowInstanceId')
CREATE INDEX IX_Finance_Officer___Reviews_For_Policy_Compliance_WorkflowInstanceId ON Finance_Officer___Reviews_For_Policy_Compliance(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Reviews_For_Policy_Compliance_UserId')
CREATE INDEX IX_Finance_Officer___Reviews_For_Policy_Compliance_UserId ON Finance_Officer___Reviews_For_Policy_Compliance(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Reviews_For_Policy_Compliance_Status')
CREATE INDEX IX_Finance_Officer___Reviews_For_Policy_Compliance_Status ON Finance_Officer___Reviews_For_Policy_Compliance(Status);
GO

PRINT 'Finance_Officer___Reviews_For_Policy_Compliance table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-expense-claim-with-expense-type,-amount,-d...', 'Employee', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-expense-claim-with-expense-type,-amount,-d...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---verifies', 'Direct_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---verifies', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---reviews-for-policy-compliance', 'Finance_Officer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---reviews-for-policy-compliance', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---processes-payment-by-entering-payment-date-and-tra...', 'Finance_Officer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---processes-payment-by-entering-payment-date-and-tra...', 'Admin', 'Admin');
GO
