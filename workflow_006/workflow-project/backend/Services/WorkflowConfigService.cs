...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""employee-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Submits_expense_claim_with_expense_type__1"",
        ...
        {
          ""taskId"": ""Task_Reviews_for_policy_compliance_4"",
        ...
        {
          ""taskId"": ""Task_Processes_payment_by_entering_payment_da_5"",
          ""currentRole"": ""Finance_Officer"",
          ""nextRoles"": [
            ""Employee""
          ],
        ...
        {
          ""taskId"": ""Task_Receives_reimbursement_confirmation_6"",
          ""currentRole"": ""Employee"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
