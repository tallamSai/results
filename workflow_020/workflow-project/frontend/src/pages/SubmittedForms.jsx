...
import Author___Creates_document_with_title__type__department__and___ from '../components/forms/Author___Creates_document_with_title,_type,_department,_and...';
import Reviewer___Checks_accuracy_and_provides_feedback from '../components/forms/Reviewer___Checks_accuracy_and_provides_feedback';

const FORM_TYPE_MAP = {
  'Author   Creates Document With Title, Type, Department, And...': Author___Creates_document_with_title__type__department__and___,
  'Author___Creates_document_with_title,_type,_department,_and...': Author___Creates_document_with_title__type__department__and___,
  'Reviewer   Checks Accuracy And Provides Feedback': Reviewer___Checks_accuracy_and_provides_feedback,
  'Reviewer___Checks_accuracy_and_provides_feedback': Reviewer___Checks_accuracy_and_provides_feedback,
};
