...
-- Schema for Author___Creates_Document_With_Title,_Type,_Department,_And...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Author___Creates_Document_With_Title,_Type,_Department,_And...')
BEGIN
    CREATE TABLE Author___Creates_Document_With_Title,_Type,_Department,_And... (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Author___Creates_Document_With_Title,_Type,_Department,_And...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Author___Creates_Document_With_Title,_Type,_Department,_And..._WorkflowInstanceId')
CREATE INDEX IX_Author___Creates_Document_With_Title,_Type,_Department,_And..._WorkflowInstanceId ON Author___Creates_Document_With_Title,_Type,_Department,_And...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Author___Creates_Document_With_Title,_Type,_Department,_And..._UserId')
CREATE INDEX IX_Author___Creates_Document_With_Title,_Type,_Department,_And..._UserId ON Author___Creates_Document_With_Title,_Type,_Department,_And...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Author___Creates_Document_With_Title,_Type,_Department,_And..._Status')
CREATE INDEX IX_Author___Creates_Document_With_Title,_Type,_Department,_And..._Status ON Author___Creates_Document_With_Title,_Type,_Department,_And...(Status);
GO

PRINT 'Author___Creates_Document_With_Title,_Type,_Department,_And... table created successfully.';
GO


-- Schema for Reviewer___Checks_Accuracy_And_Provides_Feedback
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Reviewer___Checks_Accuracy_And_Provides_Feedback')
BEGIN
    CREATE TABLE Reviewer___Checks_Accuracy_And_Provides_Feedback (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Reviewer___Checks_Accuracy_And_Provides_Feedback
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Reviewer___Checks_Accuracy_And_Provides_Feedback_WorkflowInstanceId')
CREATE INDEX IX_Reviewer___Checks_Accuracy_And_Provides_Feedback_WorkflowInstanceId ON Reviewer___Checks_Accuracy_And_Provides_Feedback(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Reviewer___Checks_Accuracy_And_Provides_Feedback_UserId')
CREATE INDEX IX_Reviewer___Checks_Accuracy_And_Provides_Feedback_UserId ON Reviewer___Checks_Accuracy_And_Provides_Feedback(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Reviewer___Checks_Accuracy_And_Provides_Feedback_Status')
CREATE INDEX IX_Reviewer___Checks_Accuracy_And_Provides_Feedback_Status ON Reviewer___Checks_Accuracy_And_Provides_Feedback(Status);
GO

PRINT 'Reviewer___Checks_Accuracy_And_Provides_Feedback table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('author---creates-document-with-title,-type,-department,-and...', 'Author', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('author---creates-document-with-title,-type,-department,-and...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('reviewer---checks-accuracy-and-provides-feedback', 'Reviewer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('reviewer---checks-accuracy-and-provides-feedback', 'Admin', 'Admin');
GO
