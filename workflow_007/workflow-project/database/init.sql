...
-- Schema for Compliance_Officer___Reviews_Visa_And_Insurance_Requirements
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Compliance_Officer___Reviews_Visa_And_Insurance_Requirements')
BEGIN
    CREATE TABLE Compliance_Officer___Reviews_Visa_And_Insurance_Requirements (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Compliance_Officer___Reviews_Visa_And_Insurance_Requirements
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Compliance_Officer___Reviews_Visa_And_Insurance_Requirements_WorkflowInstanceId')
CREATE INDEX IX_Compliance_Officer___Reviews_Visa_And_Insurance_Requirements_WorkflowInstanceId ON Compliance_Officer___Reviews_Visa_And_Insurance_Requirements(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Compliance_Officer___Reviews_Visa_And_Insurance_Requirements_UserId')
CREATE INDEX IX_Compliance_Officer___Reviews_Visa_And_Insurance_Requirements_UserId ON Compliance_Officer___Reviews_Visa_And_Insurance_Requirements(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Compliance_Officer___Reviews_Visa_And_Insurance_Requirements_Status')
CREATE INDEX IX_Compliance_Officer___Reviews_Visa_And_Insurance_Requirements_Status ON Compliance_Officer___Reviews_Visa_And_Insurance_Requirements(Status);
GO

PRINT 'Compliance_Officer___Reviews_Visa_And_Insurance_Requirements table created successfully.';
GO


-- Schema for Employee_Submits_Travel_Request_With_Destination,_Travel_Da...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Employee_Submits_Travel_Request_With_Destination,_Travel_Da...')
BEGIN
    CREATE TABLE Employee_Submits_Travel_Request_With_Destination,_Travel_Da... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Employee_Submits_Travel_Request_With_Destination,_Travel_Da...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee_Submits_Travel_Request_With_Destination,_Travel_Da..._WorkflowInstanceId')
CREATE INDEX IX_Employee_Submits_Travel_Request_With_Destination,_Travel_Da..._WorkflowInstanceId ON Employee_Submits_Travel_Request_With_Destination,_Travel_Da...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee_Submits_Travel_Request_With_Destination,_Travel_Da..._UserId')
CREATE INDEX IX_Employee_Submits_Travel_Request_With_Destination,_Travel_Da..._UserId ON Employee_Submits_Travel_Request_With_Destination,_Travel_Da...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee_Submits_Travel_Request_With_Destination,_Travel_Da..._Status')
CREATE INDEX IX_Employee_Submits_Travel_Request_With_Destination,_Travel_Da..._Status ON Employee_Submits_Travel_Request_With_Destination,_Travel_Da...(Status);
GO

PRINT 'Employee_Submits_Travel_Request_With_Destination,_Travel_Da... table created successfully.';
GO


-- Schema for Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance')
BEGIN
    CREATE TABLE Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance_WorkflowInstanceId')
CREATE INDEX IX_Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance_WorkflowInstanceId ON Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance_UserId')
CREATE INDEX IX_Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance_UserId ON Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance_Status')
CREATE INDEX IX_Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance_Status ON Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance(Status);
GO

PRINT 'Finance_Officer___Verifies_Budget_And_Issues_Travel_Advance table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee-submits-travel-request-with-destination,-travel-da...', 'Employee', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee-submits-travel-request-with-destination,-travel-da...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('compliance-officer---reviews-visa-and-insurance-requirements', 'Compliance_Officer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('compliance-officer---reviews-visa-and-insurance-requirements', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---verifies-budget-and-issues-travel-advance', 'Finance_Officer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---verifies-budget-and-issues-travel-advance', 'Admin', 'Admin');
GO
