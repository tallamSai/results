...
export default function FacilitiesCoordinatorReviewsandassignspriority({ workflowInstanceId = null, previousStageData = null }) {
  ...
  const handleSubmit = (e) => {
    ...
    const submissionData = {
      ...
      currentStage: 'Facilities Coordinator',
      formData: formData,
      action: 'submit',
