...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""employee-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Submits_maintenance_request_with_locatio_1"",
        ...
        {
          ""taskId"": ""Task_Reviews_and_assigns_priority_2"",
          ""currentRole"": ""Facilities_Coordinator"",
          ""nextRoles"": [
            ""Maintenance_Technician""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Inspects_and_provides_repair_estimate_3"",
        ...
        {
          ""taskId"": ""Task_Completes_repair_and_documents_work_done_5"",
          ""currentRole"": ""Maintenance_Technician"",
          ""nextRoles"": [
            ""Employee""
          ],
        ...
        {
          ""taskId"": ""Task_Confirms_issue_resolved_6"",
          ""currentRole"": ""Employee"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
