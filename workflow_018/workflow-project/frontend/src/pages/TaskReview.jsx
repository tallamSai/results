...
import Employee___Submits_maintenance_request_with_location__issue_t___ from '../components/forms/Employee___Submits_maintenance_request_with_location,_issue_t...';
import Facilities_Coordinator___Reviews_and_assigns_priority from '../components/forms/Facilities_Coordinator___Reviews_and_assigns_priority';
import Maintenance_Technician___Inspects_and_provides_repair_estimate__Completes_r___ from '../components/forms/Maintenance_Technician___Inspects_and_provides_repair_estimate,_Completes_r...';

const ROLE_FORM_MAP = {
  'Employee': Employee___Submits_maintenance_request_with_location__issue_t___,
  'Employee_Step1': Employee___Submits_maintenance_request_with_location__issue_t___,
  'Employee_BpmnStep2': Employee___Submits_maintenance_request_with_location__issue_t___,
  'Facilities_Coordinator': Facilities_Coordinator___Reviews_and_assigns_priority,
  'Facilities_Coordinator_Step1': Facilities_Coordinator___Reviews_and_assigns_priority,
  'Facilities_Coordinator_BpmnStep3': Facilities_Coordinator___Reviews_and_assigns_priority,
  'Maintenance_Technician': Maintenance_Technician___Inspects_and_provides_repair_estimate__Completes_r___,
  'Maintenance_Technician_Step1': Maintenance_Technician___Inspects_and_provides_repair_estimate__Completes_r___,
  'Maintenance_Technician_BpmnStep4': Maintenance_Technician___Inspects_and_provides_repair_estimate__Completes_r___,
};
