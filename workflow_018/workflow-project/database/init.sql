...
-- Schema for Employee___Submits_Maintenance_Request_With_Location,_Issue_T...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Employee___Submits_Maintenance_Request_With_Location,_Issue_T...')
BEGIN
    CREATE TABLE Employee___Submits_Maintenance_Request_With_Location,_Issue_T... (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Employee___Submits_Maintenance_Request_With_Location,_Issue_T...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Maintenance_Request_With_Location,_Issue_T..._WorkflowInstanceId')
CREATE INDEX IX_Employee___Submits_Maintenance_Request_With_Location,_Issue_T..._WorkflowInstanceId ON Employee___Submits_Maintenance_Request_With_Location,_Issue_T...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Maintenance_Request_With_Location,_Issue_T..._UserId')
CREATE INDEX IX_Employee___Submits_Maintenance_Request_With_Location,_Issue_T..._UserId ON Employee___Submits_Maintenance_Request_With_Location,_Issue_T...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Maintenance_Request_With_Location,_Issue_T..._Status')
CREATE INDEX IX_Employee___Submits_Maintenance_Request_With_Location,_Issue_T..._Status ON Employee___Submits_Maintenance_Request_With_Location,_Issue_T...(Status);
GO

PRINT 'Employee___Submits_Maintenance_Request_With_Location,_Issue_T... table created successfully.';
GO


-- Schema for Facilities_Coordinator___Reviews_And_Assigns_Priority
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Facilities_Coordinator___Reviews_And_Assigns_Priority')
BEGIN
    CREATE TABLE Facilities_Coordinator___Reviews_And_Assigns_Priority (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Facilities_Coordinator___Reviews_And_Assigns_Priority
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Facilities_Coordinator___Reviews_And_Assigns_Priority_WorkflowInstanceId')
CREATE INDEX IX_Facilities_Coordinator___Reviews_And_Assigns_Priority_WorkflowInstanceId ON Facilities_Coordinator___Reviews_And_Assigns_Priority(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Facilities_Coordinator___Reviews_And_Assigns_Priority_UserId')
CREATE INDEX IX_Facilities_Coordinator___Reviews_And_Assigns_Priority_UserId ON Facilities_Coordinator___Reviews_And_Assigns_Priority(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Facilities_Coordinator___Reviews_And_Assigns_Priority_Status')
CREATE INDEX IX_Facilities_Coordinator___Reviews_And_Assigns_Priority_Status ON Facilities_Coordinator___Reviews_And_Assigns_Priority(Status);
GO

PRINT 'Facilities_Coordinator___Reviews_And_Assigns_Priority table created successfully.';
GO


-- Schema for Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R...')
BEGIN
    CREATE TABLE Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R..._WorkflowInstanceId')
CREATE INDEX IX_Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R..._WorkflowInstanceId ON Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R..._UserId')
CREATE INDEX IX_Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R..._UserId ON Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R..._Status')
CREATE INDEX IX_Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R..._Status ON Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R...(Status);
GO

PRINT 'Maintenance_Technician___Inspects_And_Provides_Repair_Estimate,_Completes_R... table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-maintenance-request-with-location,-issue-t...', 'Employee', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-maintenance-request-with-location,-issue-t...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('facilities-coordinator---reviews-and-assigns-priority', 'Facilities_Coordinator', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('facilities-coordinator---reviews-and-assigns-priority', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('maintenance-technician---inspects-and-provides-repair-estimate,-completes-r...', 'Maintenance_Technician', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('maintenance-technician---inspects-and-provides-repair-estimate,-completes-r...', 'Admin', 'Admin');
GO
