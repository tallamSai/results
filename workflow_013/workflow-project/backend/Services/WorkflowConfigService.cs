...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""it-staff-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Submits_change_request_with_change_title_1"",
          ""currentRole"": ""IT_Staff"",
          ""nextRoles"": [
            ""Change_Manager""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Reviews_completeness_2"",
          ""currentRole"": ""Change_Manager"",
          ""nextRoles"": [
            ""IT_Staff""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Implements_change_4"",
          ""currentRole"": ""IT_Staff"",
          ""nextRoles"": [
            ""IT_Staff""
          ],
        ...
        {
          ""taskId"": ""Task_Verifies_success_and_closes_the_change_r_5"",
          ""currentRole"": ""IT_Staff"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
