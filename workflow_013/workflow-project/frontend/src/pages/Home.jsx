...
export default function Home() {
  ...
  const allForms = [
    { route: 'it-staff---submits-change-request-with-change-title,-descript...', name: 'IT Staff   Submits Change Request With Change Title, Descript...', description: 'Navigation component with workspace tabs and search functionality...', role: 'IT_Staff' }
  ];
