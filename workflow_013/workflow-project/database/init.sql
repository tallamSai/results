...
-- Schema for Change_Manager___Reviews_Completeness
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Change_Manager___Reviews_Completeness')
BEGIN
    CREATE TABLE Change_Manager___Reviews_Completeness (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Change_Manager___Reviews_Completeness
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Change_Manager___Reviews_Completeness_WorkflowInstanceId')
CREATE INDEX IX_Change_Manager___Reviews_Completeness_WorkflowInstanceId ON Change_Manager___Reviews_Completeness(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Change_Manager___Reviews_Completeness_UserId')
CREATE INDEX IX_Change_Manager___Reviews_Completeness_UserId ON Change_Manager___Reviews_Completeness(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Change_Manager___Reviews_Completeness_Status')
CREATE INDEX IX_Change_Manager___Reviews_Completeness_Status ON Change_Manager___Reviews_Completeness(Status);
GO

PRINT 'Change_Manager___Reviews_Completeness table created successfully.';
GO


-- Schema for IT_Staff___Submits_Change_Request_With_Change_Title,_Descript...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'IT_Staff___Submits_Change_Request_With_Change_Title,_Descript...')
BEGIN
    CREATE TABLE IT_Staff___Submits_Change_Request_With_Change_Title,_Descript... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for IT_Staff___Submits_Change_Request_With_Change_Title,_Descript...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Staff___Submits_Change_Request_With_Change_Title,_Descript..._WorkflowInstanceId')
CREATE INDEX IX_IT_Staff___Submits_Change_Request_With_Change_Title,_Descript..._WorkflowInstanceId ON IT_Staff___Submits_Change_Request_With_Change_Title,_Descript...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Staff___Submits_Change_Request_With_Change_Title,_Descript..._UserId')
CREATE INDEX IX_IT_Staff___Submits_Change_Request_With_Change_Title,_Descript..._UserId ON IT_Staff___Submits_Change_Request_With_Change_Title,_Descript...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Staff___Submits_Change_Request_With_Change_Title,_Descript..._Status')
CREATE INDEX IX_IT_Staff___Submits_Change_Request_With_Change_Title,_Descript..._Status ON IT_Staff___Submits_Change_Request_With_Change_Title,_Descript...(Status);
GO

PRINT 'IT_Staff___Submits_Change_Request_With_Change_Title,_Descript... table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-staff---submits-change-request-with-change-title,-descript...', 'IT_Staff', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-staff---submits-change-request-with-change-title,-descript...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('change-manager---reviews-completeness', 'Change_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('change-manager---reviews-completeness', 'Admin', 'Admin');
GO
