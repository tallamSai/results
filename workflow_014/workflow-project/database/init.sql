...
-- Schema for Employee___Requests_Software_With_Software_Name,_Version,_Bus...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Employee___Requests_Software_With_Software_Name,_Version,_Bus...')
BEGIN
    CREATE TABLE Employee___Requests_Software_With_Software_Name,_Version,_Bus... (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Employee___Requests_Software_With_Software_Name,_Version,_Bus...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Requests_Software_With_Software_Name,_Version,_Bus..._WorkflowInstanceId')
CREATE INDEX IX_Employee___Requests_Software_With_Software_Name,_Version,_Bus..._WorkflowInstanceId ON Employee___Requests_Software_With_Software_Name,_Version,_Bus...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Requests_Software_With_Software_Name,_Version,_Bus..._UserId')
CREATE INDEX IX_Employee___Requests_Software_With_Software_Name,_Version,_Bus..._UserId ON Employee___Requests_Software_With_Software_Name,_Version,_Bus...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Requests_Software_With_Software_Name,_Version,_Bus..._Status')
CREATE INDEX IX_Employee___Requests_Software_With_Software_Name,_Version,_Bus..._Status ON Employee___Requests_Software_With_Software_Name,_Version,_Bus...(Status);
GO

PRINT 'Employee___Requests_Software_With_Software_Name,_Version,_Bus... table created successfully.';
GO


-- Schema for IT_Administrator_Installs_Software_And_Assigns_License
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'IT_Administrator_Installs_Software_And_Assigns_License')
BEGIN
    CREATE TABLE IT_Administrator_Installs_Software_And_Assigns_License (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for IT_Administrator_Installs_Software_And_Assigns_License
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Administrator_Installs_Software_And_Assigns_License_WorkflowInstanceId')
CREATE INDEX IX_IT_Administrator_Installs_Software_And_Assigns_License_WorkflowInstanceId ON IT_Administrator_Installs_Software_And_Assigns_License(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Administrator_Installs_Software_And_Assigns_License_UserId')
CREATE INDEX IX_IT_Administrator_Installs_Software_And_Assigns_License_UserId ON IT_Administrator_Installs_Software_And_Assigns_License(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_IT_Administrator_Installs_Software_And_Assigns_License_Status')
CREATE INDEX IX_IT_Administrator_Installs_Software_And_Assigns_License_Status ON IT_Administrator_Installs_Software_And_Assigns_License(Status);
GO

PRINT 'IT_Administrator_Installs_Software_And_Assigns_License table created successfully.';
GO


-- Schema for It_Procurement_Checks_Existing_Licenses_And_Vendor_Options
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'It_Procurement_Checks_Existing_Licenses_And_Vendor_Options')
BEGIN
    CREATE TABLE It_Procurement_Checks_Existing_Licenses_And_Vendor_Options (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for It_Procurement_Checks_Existing_Licenses_And_Vendor_Options
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_It_Procurement_Checks_Existing_Licenses_And_Vendor_Options_WorkflowInstanceId')
CREATE INDEX IX_It_Procurement_Checks_Existing_Licenses_And_Vendor_Options_WorkflowInstanceId ON It_Procurement_Checks_Existing_Licenses_And_Vendor_Options(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_It_Procurement_Checks_Existing_Licenses_And_Vendor_Options_UserId')
CREATE INDEX IX_It_Procurement_Checks_Existing_Licenses_And_Vendor_Options_UserId ON It_Procurement_Checks_Existing_Licenses_And_Vendor_Options(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_It_Procurement_Checks_Existing_Licenses_And_Vendor_Options_Status')
CREATE INDEX IX_It_Procurement_Checks_Existing_Licenses_And_Vendor_Options_Status ON It_Procurement_Checks_Existing_Licenses_And_Vendor_Options(Status);
GO

PRINT 'It_Procurement_Checks_Existing_Licenses_And_Vendor_Options table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---requests-software-with-software-name,-version,-bus...', 'Employee', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---requests-software-with-software-name,-version,-bus...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-procurement-checks-existing-licenses-and-vendor-options', 'IT_Procurement', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-procurement-checks-existing-licenses-and-vendor-options', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-administrator-installs-software-and-assigns-license', 'IT_Administrator', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('it-administrator-installs-software-and-assigns-license', 'Admin', 'Admin');
GO
