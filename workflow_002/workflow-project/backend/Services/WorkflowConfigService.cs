...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""employee-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Submits_leave_request_with_leave_type_st_1"",
        ...
        {
          ""taskId"": ""Task_Reviews_leave_request_2"",
        ...
        {
          ""taskId"": ""Task_Updates_leave_balance_and_records_approv_5"",
          ""currentRole"": ""HR_Representative"",
          ""nextRoles"": [],
          ""denyRoles"": []
        },
        {
          ""taskId"": ""Task_Is_notified_4"",
          ""currentRole"": ""Employee"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
