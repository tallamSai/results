...
const FORM_TYPE_MAP = {
  'Direct Manager   Reviews Leave Request': Direct_Manager___Reviews_leave_request,
  'Direct_Manager___Reviews_leave_request': Direct_Manager___Reviews_leave_request,
  'Employee   Submits Leave Request With Leave Type, Start Date,...': Employee___Submits_leave_request_with_leave_type__start_date____,
  'Employee___Submits_leave_request_with_leave_type,_start_date,...': Employee___Submits_leave_request_with_leave_type__start_date____,
  'HR_Representative___Updates_leave_balance_and_records_approved_leave_i...': HR_Representative___Updates_leave_balance_and_records_approved_leave_i___,
  'HR_Representative___Updates_leave_balance_and_records_approved_leave_i...': HR_Representative___Updates_leave_balance_and_records_approved_leave_i___,
};
