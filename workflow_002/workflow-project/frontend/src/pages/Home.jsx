...
export default function Home() {
  ...
  const allForms = [
    { route: 'employee---submits-leave-request-with-leave-type,-start-date,...', name: 'Employee   Submits Leave Request With Leave Type, Start Date,...', description: 'Employee submits a leave request specifying leave type, start date, and other required details...', role: 'Employee' }
  ];
