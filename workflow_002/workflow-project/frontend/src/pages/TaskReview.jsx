...
import Direct_Manager___Reviews_leave_request from '../components/forms/Direct_Manager___Reviews_leave_request';
import Employee___Submits_leave_request_with_leave_type__start_date____ from '../components/forms/Employee___Submits_leave_request_with_leave_type,_start_date,...';
import HR_Representative___Updates_leave_balance_and_records_approved_leave_i___ from '../components/forms/HR_Representative___Updates_leave_balance_and_records_approved_leave_i...';

const ROLE_FORM_MAP = {
  'Employee': Employee___Submits_leave_request_with_leave_type__start_date____,
  'Employee_Step1': Employee___Submits_leave_request_with_leave_type__start_date____,
  'Employee_BpmnStep2': Employee___Submits_leave_request_with_leave_type__start_date____,
  'Direct_Manager': Direct_Manager___Reviews_leave_request,
  'Direct_Manager_Step1': Direct_Manager___Reviews_leave_request,
  'Direct_Manager_BpmnStep3': Direct_Manager___Reviews_leave_request,
  'HR_Representative': HR_Representative___Updates_leave_balance_and_records_approved_leave_i___,
  'HR_Representative_Step1': HR_Representative___Updates_leave_balance_and_records_approved_leave_i___,
  'HR_Representative_BpmnStep5': HR_Representative___Updates_leave_balance_and_records_approved_leave_i___,
};
