...
-- Schema for Direct_Manager___Reviews_Leave_Request
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Direct_Manager___Reviews_Leave_Request')
BEGIN
    CREATE TABLE Direct_Manager___Reviews_Leave_Request (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Direct_Manager___Reviews_Leave_Request
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Reviews_Leave_Request_WorkflowInstanceId')
CREATE INDEX IX_Direct_Manager___Reviews_Leave_Request_WorkflowInstanceId ON Direct_Manager___Reviews_Leave_Request(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Reviews_Leave_Request_UserId')
CREATE INDEX IX_Direct_Manager___Reviews_Leave_Request_UserId ON Direct_Manager___Reviews_Leave_Request(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Reviews_Leave_Request_Status')
CREATE INDEX IX_Direct_Manager___Reviews_Leave_Request_Status ON Direct_Manager___Reviews_Leave_Request(Status);
GO

PRINT 'Direct_Manager___Reviews_Leave_Request table created successfully.';
GO


-- Schema for Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,...')
BEGIN
    CREATE TABLE Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,..._WorkflowInstanceId')
CREATE INDEX IX_Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,..._WorkflowInstanceId ON Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,..._UserId')
CREATE INDEX IX_Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,..._UserId ON Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,..._Status')
CREATE INDEX IX_Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,..._Status ON Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,...(Status);
GO

PRINT 'Employee___Submits_Leave_Request_With_Leave_Type,_Start_Date,... table created successfully.';
GO


-- Schema for HR_Representative___Updates_leave_balance_and_records_approved_leave_i...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'HR_Representative___Updates_leave_balance_and_records_approved_leave_i...')
BEGIN
    CREATE TABLE HR_Representative___Updates_leave_balance_and_records_approved_leave_i... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for HR_Representative___Updates_leave_balance_and_records_approved_leave_i...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Updates_leave_balance_and_records_approved_leave_i..._WorkflowInstanceId')
CREATE INDEX IX_HR_Representative___Updates_leave_balance_and_records_approved_leave_i..._WorkflowInstanceId ON HR_Representative___Updates_leave_balance_and_records_approved_leave_i...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Updates_leave_balance_and_records_approved_leave_i..._UserId')
CREATE INDEX IX_HR_Representative___Updates_leave_balance_and_records_approved_leave_i..._UserId ON HR_Representative___Updates_leave_balance_and_records_approved_leave_i...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative___Updates_leave_balance_and_records_approved_leave_i..._Status')
CREATE INDEX IX_HR_Representative___Updates_leave_balance_and_records_approved_leave_i..._Status ON HR_Representative___Updates_leave_balance_and_records_approved_leave_i...(Status);
GO

PRINT 'HR_Representative___Updates_leave_balance_and_records_approved_leave_i... table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-leave-request-with-leave-type,-start-date,...', 'Employee', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-leave-request-with-leave-type,-start-date,...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---reviews-leave-request', 'Direct_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---reviews-leave-request', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative---updates-leave-balance-and-records-approved-leave-i...', 'HR_Representative', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative---updates-leave-balance-and-records-approved-leave-i...', 'Admin', 'Admin');
GO
