...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""procurement-officer-workflow"": {
      ""name"": ""Procurement_Officer Workflow"",
      ""roleSequence"": [
        ""Procurement_Officer"",
        ""Procurement_Analyst"",
        ""Procurement_Manager""
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Creates_RFQ_with_item_specifications_qua_1"",
        ...
        {
          ""taskId"": ""Task_Sends_RFQ_to_approved_vendors_2"",
          ""currentRole"": ""Procurement_Officer"",
          ""nextRoles"": [
            ""Procurement_Analyst""
          ],
        ...
        {
          ""taskId"": ""Task_Evaluates_quotes_based_on_price_quality__3"",
          ""currentRole"": ""Procurement_Analyst"",
          ""nextRoles"": [
            ""Procurement_Manager""
          ],
          ""denyRoles"": []
        ...
        {
          ""taskId"": ""Task_Selects_winning_vendor_4"",
        ...
        {
          ""taskId"": ""Task_Notifies_all_vendors_of_decision_5"",
          ""currentRole"": ""Procurement_Officer"",
          ""nextRoles"": [
            ""Procurement_Officer""
          ],
        ...
        {
          ""taskId"": ""Task_Initiates_purchase_order_for_selected_ve_6"",
          ""currentRole"": ""Procurement_Officer"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
