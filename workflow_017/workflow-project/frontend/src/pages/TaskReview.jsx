...
import Procurement_Analyst___Evaluates_quotes_based_on_price__quality__and_deli___ from '../components/forms/Procurement_Analyst___Evaluates_quotes_based_on_price,_quality,_and_deli...';
import Procurement_Manager___Selects_winning_vendor from '../components/forms/Procurement_Manager___Selects_winning_vendor';
import Procurement_Officer___Creates_RFQ_with_item_specifications__quantity__de___ from '../components/forms/Procurement_Officer___Creates_RFQ_with_item_specifications,_quantity,_de...';
import Procurement_Officer___Sends_RFQ_to_approved_vendors from '../components/forms/Procurement_Officer___Sends_RFQ_to_approved_vendors';

const ROLE_FORM_MAP = {
  'Procurement_Officer': Procurement_Officer___Creates_RFQ_with_item_specifications__quantity__de___,
  'Procurement_Officer_Step1': Procurement_Officer___Creates_RFQ_with_item_specifications__quantity__de___,
  'Procurement_Officer_BpmnStep2': Procurement_Officer___Creates_RFQ_with_item_specifications__quantity__de___,
  'Procurement_Officer_Step2': Procurement_Officer___Sends_RFQ_to_approved_vendors,
  'Procurement_Officer_BpmnStep3': Procurement_Officer___Sends_RFQ_to_approved_vendors,
  'Procurement_Analyst': Procurement_Analyst___Evaluates_quotes_based_on_price__quality__and_deli___,
  'Procurement_Analyst_Step1': Procurement_Analyst___Evaluates_quotes_based_on_price__quality__and_deli___,
  'Procurement_Analyst_BpmnStep4': Procurement_Analyst___Evaluates_quotes_based_on_price__quality__and_deli___,
  'Procurement_Manager': Procurement_Manager___Selects_winning_vendor,
  'Procurement_Manager_Step1': Procurement_Manager___Selects_winning_vendor,
  'Procurement_Manager_BpmnStep5': Procurement_Manager___Selects_winning_vendor,
};
