...
import Compliance_Officer___Reviews_visa_and_insurance_requirements from '../components/forms/Compliance_Officer___Reviews_visa_and_insurance_requirements';
import Employee___Submits_travel_request_with_destination__travel_da___ from '../components/forms/Employee___Submits_travel_request_with_destination,_travel_da...';
import Finance_Officer___Verifies_budget_and_issues_travel_advance from '../components/forms/Finance_Officer___Verifies_budget_and_issues_travel_advance';

const ROLE_FORM_MAP = {
  'Employee': Employee___Submits_travel_request_with_destination__travel_da___,
  'Employee_Step1': Employee___Submits_travel_request_with_destination__travel_da___,
  'Employee_BpmnStep2': Employee___Submits_travel_request_with_destination__travel_da___,
  'Compliance_Officer': Compliance_Officer___Reviews_visa_and_insurance_requirements,
  'Compliance_Officer_Step1': Compliance_Officer___Reviews_visa_and_insurance_requirements,
  'Compliance_Officer_BpmnStep4': Compliance_Officer___Reviews_visa_and_insurance_requirements,
  'Finance_Officer': Finance_Officer___Verifies_budget_and_issues_travel_advance,
  'Finance_Officer_Step1': Finance_Officer___Verifies_budget_and_issues_travel_advance,
  'Finance_Officer_BpmnStep6': Finance_Officer___Verifies_budget_and_issues_travel_advance,
};
