        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200">
          <div className="px-8 py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-gray-700">
                    Visa Requirement Status <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <select
                      value={formData['question_1799823d'] || ''}
                      onChange={e => handleInputChange('question_1799823d', e.target.value)}
                    ...
                    >
                      ...
                      <option value="Visa Required">Visa Required</option><option value="Visa Not Required">Visa Not Required</option><option value="Exempt">Exempt</option><option value="Unknown">Unknown</option>
                    </select>
                ...
                <div className="flex flex-col gap-2 mb-6">
                  <label className="text-sm font-medium text-gray-700">
                    Visa Instructions/Notes
                  </label>
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_f4189521'] || ''}
                      onChange={e => handleInputChange('question_f4189521', e.target.value)}
                      placeholder="Provide specific visa requirements, documentation needed, or exemptions"
                      rows="4"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-gray-700">
                    Insurance Coverage Status <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <select
                      value={formData['question_e691a865'] || ''}
                      onChange={e => handleInputChange('question_e691a865', e.target.value)}
                      className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors bg-white"
                      required
                    >
                      <option value="">Select an option</option>
                      <option value="Coverage Provided">Coverage Provided</option><option value="Coverage Not Provided">Coverage Not Provided</option><option value="Additional Coverage Needed">Additional Coverage Needed</option><option value="Unknown">Unknown</option>
                    </select>
                    <svg className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    </svg>
                ...
                <div className="flex flex-col gap-2 mb-6">
                  ...
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_5e612f1e'] || ''}
                      onChange={e => handleInputChange('question_5e612f1e', e.target.value)}
                      placeholder="Document insurance coverage details, limitations, or additional requirements"
                      rows="4"
                      className="w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 outline-none resize-none rounded-md focus:ring-2 focus:ring-blue-500 transition-colors"
            ...
            >
              <input
                type="radio"
                name="question_facb1e6a"
                value="Yes"
                checked={formData['question_facb1e6a'] === 'Yes'}
                onChange={e => handleInputChange('question_facb1e6a', e.target.value)}
            ...
            >
              <input
                ...
                name="question_facb1e6a"
                value="No"
                checked={formData['question_facb1e6a'] === 'No'}
                onChange={e => handleInputChange('question_facb1e6a', e.target.value)}
                className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">No</span>
                ...
                <div className="flex flex-col gap-2 mb-6">
                  ...
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_7f579ff5'] || ''}
                      onChange={e => handleInputChange('question_7f579ff5', e.target.value)}
                      placeholder="Describe any compliance issues or risks found during review"
                      rows="4"
                      className="w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 outline-none resize-none rounded-md focus:ring-2 focus:ring-blue-500 transition-colors"
