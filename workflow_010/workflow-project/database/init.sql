...
-- Schema for Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance')
BEGIN
    CREATE TABLE Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance_WorkflowInstanceId')
CREATE INDEX IX_Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance_WorkflowInstanceId ON Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance_UserId')
CREATE INDEX IX_Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance_UserId ON Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance_Status')
CREATE INDEX IX_Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance_Status ON Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance(Status);
GO

PRINT 'Finance_Officer_Verifies_Budget_And_Issues_Travel_Advance table created successfully.';
GO
