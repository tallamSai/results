...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""employee-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Submits_travel_request_with_destination__1"",
        ...
        {
          ""taskId"": ""Task_Reviews_visa_and_insurance_requirements_3"",
        ...
        {
          ""taskId"": ""Task_Verifies_budget_and_issues_travel_advanc_4"",
        ...
        {
          ""taskId"": ""Task_Submits_actual_expenses_for_reconciliati_5"",
          ""currentRole"": ""Employee"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
