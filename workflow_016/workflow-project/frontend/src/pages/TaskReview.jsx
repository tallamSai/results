...
import Contract_Manager___Drafts_contract_with_vendor_name__contract_type__v___ from '../components/forms/Contract_Manager___Drafts_contract_with_vendor_name,_contract_type,_v...';
import Finance_Director___Confirms_budget_availability from '../components/forms/Finance_Director___Confirms_budget_availability';
import Legal_Counsel___Reviews_and_suggests_modifications from '../components/forms/Legal_Counsel___Reviews_and_suggests_modifications';

const ROLE_FORM_MAP = {
  'Contract_Manager': Contract_Manager___Drafts_contract_with_vendor_name__contract_type__v___,
  'Contract_Manager_Step1': Contract_Manager___Drafts_contract_with_vendor_name__contract_type__v___,
  'Contract_Manager_BpmnStep2': Contract_Manager___Drafts_contract_with_vendor_name__contract_type__v___,
  'Legal_Counsel': Legal_Counsel___Reviews_and_suggests_modifications,
  'Legal_Counsel_Step1': Legal_Counsel___Reviews_and_suggests_modifications,
  'Legal_Counsel_BpmnStep3': Legal_Counsel___Reviews_and_suggests_modifications,
  'Finance_Director': Finance_Director___Confirms_budget_availability,
  'Finance_Director_Step1': Finance_Director___Confirms_budget_availability,
  'Finance_Director_BpmnStep4': Finance_Director___Confirms_budget_availability,
};
