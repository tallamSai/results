...
const FORM_TYPE_MAP = {
  'Contract Manager   Drafts Contract With Vendor Name, Contract Type, V...': Contract_Manager___Drafts_contract_with_vendor_name__contract_type__v___,
  'Contract_Manager___Drafts_contract_with_vendor_name,_contract_type,_v...': Contract_Manager___Drafts_contract_with_vendor_name__contract_type__v___,
  'Finance Director   Confirms Budget Availability': Finance_Director___Confirms_budget_availability,
  'Finance_Director___Confirms_budget_availability': Finance_Director___Confirms_budget_availability,
  'Legal Counsel   Reviews And Suggests Modifications': Legal_Counsel___Reviews_and_suggests_modifications,
  'Legal_Counsel___Reviews_and_suggests_modifications': Legal_Counsel___Reviews_and_suggests_modifications,
};
