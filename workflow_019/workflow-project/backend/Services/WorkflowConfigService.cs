...
namespace WorkflowManagementSystem.Services
{
  ...
  ""workflows"": {
    ""employee-workflow"": {
      ...
      ""routingRules"": [
        {
          ""taskId"": ""Task_Requests_visitor_access_with_visitor_nam_1"",
        ...
        {
          ""taskId"": ""Task_Runs_background_check_for_sensitive_area_3"",
        ...
        {
          ""taskId"": ""Task_Prepares_visitor_badge_4"",
          ""currentRole"": ""Reception_Desk"",
          ""nextRoles"": [],
          ""denyRoles"": []
        }
      ]
