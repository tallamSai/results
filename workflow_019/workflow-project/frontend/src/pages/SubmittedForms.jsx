...
const FORM_TYPE_MAP = {
  'Employee Requests Visitor Access With Visitor Name, Company': Employee___Requests_visitor_access_with_visitor_name__company___,
  'Employee___Requests_visitor_access_with_visitor_name,_company...': Employee___Requests_visitor_access_with_visitor_name__company___,
  'Reception Desk Prepares Visitor Badge': Reception_Desk___Prepares_visitor_badge,
  'Reception_Desk___Prepares_visitor_badge': Reception_Desk___Prepares_visitor_badge,
  'Security Officer Runs Background Check For Sensitive Areas': Security_Officer___Runs_background_check_for_sensitive_areas,
  'Security_Officer___Runs_background_check_for_sensitive_areas': Security_Officer___Runs_background_check_for_sensitive_areas,
};
