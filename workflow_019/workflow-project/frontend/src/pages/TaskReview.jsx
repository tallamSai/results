...
import Employee___Requests_visitor_access_with_visitor_name__company___ from '../components/forms/Employee___Requests_visitor_access_with_visitor_name,_company...';
import Reception_Desk___Prepares_visitor_badge from '../components/forms/Reception_Desk___Prepares_visitor_badge';
import Security_Officer___Runs_background_check_for_sensitive_areas from '../components/forms/Security_Officer___Runs_background_check_for_sensitive_areas';

const ROLE_FORM_MAP = {
  'Employee': Employee___Requests_visitor_access_with_visitor_name__company___,
  'Employee_Step1': Employee___Requests_visitor_access_with_visitor_name__company___,
  'Employee_BpmnStep2': Employee___Requests_visitor_access_with_visitor_name__company___,
  'Security_Officer': Security_Officer___Runs_background_check_for_sensitive_areas,
  'Security_Officer_Step1': Security_Officer___Runs_background_check_for_sensitive_areas,
  'Security_Officer_BpmnStep4': Security_Officer___Runs_background_check_for_sensitive_areas,
  'Reception_Desk': Reception_Desk___Prepares_visitor_badge,
  'Reception_Desk_Step1': Reception_Desk___Prepares_visitor_badge,
  'Reception_Desk_BpmnStep6': Reception_Desk___Prepares_visitor_badge,
};
