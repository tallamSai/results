...
import Direct_Manager___Reviews_relevance from '../components/forms/Direct_Manager___Reviews_relevance';
import Employee___Submits_a_training_request_with_course_name__train___ from '../components/forms/Employee___Submits_a_training_request_with_course_name,_train...';
import Finance_Officer___Processes_payment from '../components/forms/Finance_Officer___Processes_payment';
import HR_Representative___Enrolls_the_employee_and_sends_confirmation_with_t___ from '../components/forms/HR_Representative___Enrolls_the_employee_and_sends_confirmation_with_t...';

const ROLE_FORM_MAP = {
  'Employee': Employee___Submits_a_training_request_with_course_name__train___,
  'Employee_Step1': Employee___Submits_a_training_request_with_course_name__train___,
  'Employee_BpmnStep2': Employee___Submits_a_training_request_with_course_name__train___,
  'Direct_Manager': Direct_Manager___Reviews_relevance,
  'Direct_Manager_Step1': Direct_Manager___Reviews_relevance,
  'Direct_Manager_BpmnStep3': Direct_Manager___Reviews_relevance,
  'Finance_Officer': Finance_Officer___Processes_payment,
  'Finance_Officer_Step1': Finance_Officer___Processes_payment,
  'Finance_Officer_BpmnStep5': Finance_Officer___Processes_payment,
  'HR_Representative': HR_Representative___Enrolls_the_employee_and_sends_confirmation_with_t___,
  'HR_Representative_Step1': HR_Representative___Enrolls_the_employee_and_sends_confirmation_with_t___,
  'HR_Representative_BpmnStep7': HR_Representative___Enrolls_the_employee_and_sends_confirmation_with_t___,
};
