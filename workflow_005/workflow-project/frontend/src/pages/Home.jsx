...
export default function Home() {
  ...
  const allForms = [
    { route: 'employee---submits-a-training-request-with-course-name,-train...', name: 'Employee   Submits A Training Request With Course Name, Train...', description: 'Form for employee to submit training requests with course details (no form implementation found in p...', role: 'Employee' }
  ];
