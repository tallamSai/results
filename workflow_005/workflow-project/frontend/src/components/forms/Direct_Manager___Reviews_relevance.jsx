...
export default function DirectManagerReviewsrelevance({ workflowInstanceId = null, previousStageData = null, onSubmit, loading, initialData = {}, disabled = false }) {
  const [formData, setFormData] = useState(initialData);
  
  // Update formData when initialData changes (important for read-only display)
  useEffect(() => {
    if (initialData && Object.keys(initialData).length > 0) {
      console.log(`📝 Form (DirectManagerReviewsrelevance): Loading initialData:`, initialData);
...
const handleSubmit = (e) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      />
      <EmployeeHeader 
        title="Direct Manager - Reviews relevance"
      ...
      <div className="max-w-6xl mx-auto px-6 py-3">
        <div className="flex items-center text-sm text-gray-600">
          ...
          <span className="text-gray-900 font-medium">Direct Manager - Reviews relevance</span>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200">
          <div className="px-8 py-6">
            ...
            >
              <input
                type="radio"
                name="question_da49edd8"
                value="Approve"
                checked={formData['question_da49edd8'] === 'Approve'}
                onChange={e => handleInputChange('question_da49edd8', e.target.value)}
            ...
            >
              <input
                ...
                name="question_da49edd8"
                value="Reject"
                checked={formData['question_da49edd8'] === 'Reject'}
                onChange={e => handleInputChange('question_da49edd8', e.target.value)}
                className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">Reject</span>
                ...
                <div className="flex flex-col gap-2 mb-6">
                  ...
                  <div className="bg-white border border-gray-300 rounded-md">
                    <textarea
                      value={formData['question_6ce516e4'] || ''}
                      onChange={e => handleInputChange('question_6ce516e4', e.target.value)}
                      placeholder="Provide detailed feedback on the training request's relevance to business needs"
                      rows="4"
