...
-- Schema for Direct_Manager___Reviews_Relevance
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Direct_Manager___Reviews_Relevance')
BEGIN
    CREATE TABLE Direct_Manager___Reviews_Relevance (
        Id INT PRIMARY KEY IDENTITY(1,1),
...
-- Indexes for Direct_Manager___Reviews_Relevance
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Reviews_Relevance_WorkflowInstanceId')
CREATE INDEX IX_Direct_Manager___Reviews_Relevance_WorkflowInstanceId ON Direct_Manager___Reviews_Relevance(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Reviews_Relevance_UserId')
CREATE INDEX IX_Direct_Manager___Reviews_Relevance_UserId ON Direct_Manager___Reviews_Relevance(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Direct_Manager___Reviews_Relevance_Status')
CREATE INDEX IX_Direct_Manager___Reviews_Relevance_Status ON Direct_Manager___Reviews_Relevance(Status);
GO

PRINT 'Direct_Manager___Reviews_Relevance table created successfully.';
GO


-- Schema for Employee___Submits_A_Training_Request_With_Course_Name,_Train...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Employee___Submits_A_Training_Request_With_Course_Name,_Train...')
BEGIN
    CREATE TABLE Employee___Submits_A_Training_Request_With_Course_Name,_Train... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Employee___Submits_A_Training_Request_With_Course_Name,_Train...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_A_Training_Request_With_Course_Name,_Train..._WorkflowInstanceId')
CREATE INDEX IX_Employee___Submits_A_Training_Request_With_Course_Name,_Train..._WorkflowInstanceId ON Employee___Submits_A_Training_Request_With_Course_Name,_Train...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_A_Training_Request_With_Course_Name,_Train..._UserId')
CREATE INDEX IX_Employee___Submits_A_Training_Request_With_Course_Name,_Train..._UserId ON Employee___Submits_A_Training_Request_With_Course_Name,_Train...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Employee___Submits_A_Training_Request_With_Course_Name,_Train..._Status')
CREATE INDEX IX_Employee___Submits_A_Training_Request_With_Course_Name,_Train..._Status ON Employee___Submits_A_Training_Request_With_Course_Name,_Train...(Status);
GO

PRINT 'Employee___Submits_A_Training_Request_With_Course_Name,_Train... table created successfully.';
GO


-- Schema for Finance_Officer___Processes_Payment
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Finance_Officer___Processes_Payment')
BEGIN
    CREATE TABLE Finance_Officer___Processes_Payment (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for Finance_Officer___Processes_Payment
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Processes_Payment_WorkflowInstanceId')
CREATE INDEX IX_Finance_Officer___Processes_Payment_WorkflowInstanceId ON Finance_Officer___Processes_Payment(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Processes_Payment_UserId')
CREATE INDEX IX_Finance_Officer___Processes_Payment_UserId ON Finance_Officer___Processes_Payment(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Finance_Officer___Processes_Payment_Status')
CREATE INDEX IX_Finance_Officer___Processes_Payment_Status ON Finance_Officer___Processes_Payment(Status);
GO

PRINT 'Finance_Officer___Processes_Payment table created successfully.';
GO


-- Schema for HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T...')
BEGIN
    CREATE TABLE HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T... (
        Id INT PRIMARY KEY IDENTITY(1,1),
        WorkflowInstanceId INT NULL,
        UserId INT NOT NULL,
        FormData NVARCHAR(MAX) NOT NULL,
...
-- Indexes for HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T..._WorkflowInstanceId')
CREATE INDEX IX_HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T..._WorkflowInstanceId ON HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T...(WorkflowInstanceId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T..._UserId')
CREATE INDEX IX_HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T..._UserId ON HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T...(UserId);
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T..._Status')
CREATE INDEX IX_HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T..._Status ON HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T...(Status);
GO

PRINT 'HR_Representative_Enrolls_the_Employee_and_Sends_Confirmation_With_T... table created successfully.';
GO
...
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-a-training-request-with-course-name,-train...', 'Employee', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('employee---submits-a-training-request-with-course-name,-train...', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---reviews-relevance', 'Direct_Manager', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('direct-manager---reviews-relevance', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---processes-payment', 'Finance_Officer', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('finance-officer---processes-payment', 'Admin', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative-enrolls-the-employee-and-sends-confirmation-with-t...', 'HR_Representative', 'Admin');
INSERT INTO FormRoleMapping (FormType, AllowedRole, TargetRoles) VALUES ('hr-representative-enrolls-the-employee-and-sends-confirmation-with-t...', 'Admin', 'Admin');
GO
